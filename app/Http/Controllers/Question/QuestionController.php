    ...
    */
    public function store(Request $request){
        try {
            ...
            if($question->save()){
                if($this->storeAnswer($request, $questionId)){
                    return redirect()->route('get.question.list')->with('success', 'You have successfully added this question!');
                }
                else{
                    $question->delete();
                    return redirect()->route('get.question.list')->with('error', 'There are problem with your Answer input data, the question has not been added to the database');
                }
            }else{
    ...
    public function storeAnswer(Request $request, $questionId){
        try{
            foreach($request->answer as $index=>$ans){
                ...
                $answer->answer = $ans->answer[$index];
                $answer->is_correct = $ans->is_correct[$index];
