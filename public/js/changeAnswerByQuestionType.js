...
function singleChoiceOfFour() {
  $("#answer-block").empty();
  var html = '<div class="form-group">' + '<label for"firstAnswer">First Answer</label>' + '<input type="text" class="form-control">' + '<div class="form-check">' + '<input class="form-check-input" type="radio">' + '<label class="form-check-label" > is correct </label>' + '</div>' + '</div>' + '<div class="form-group">' + '<label for"firstAnswer">Second Answer</label>' + '<input type="text" class="form-control">' + '<div class="form-check">' + '<input class="form-check-input" type="radio">' + '<label class="form-check-label" > is correct </label>' + '</div>' + '</div>' + '<div class="form-group">' + '<label for"firstAnswer">Third Answer</label>' + '<input type="text" class="form-control">' + '<div class="form-check">' + '<input class="form-check-input" type="radio">' + '<label class="form-check-label" > is correct </label>' + '</div>' + '</div>' + '<div class="form-group">' + '<label for"firstAnswer">Fourth Answer</label>' + '<input type="text" class="form-control">' + '<div class="form-check">' + '<input class="form-check-input" type="radio">' + '<label class="form-check-label" > is correct </label>' + '</div>' + '</div>';
...
function trueFalse() {
  $("#answer-block").empty();
  var html = '<div class="form-group">' + '<label for"firstAnswer">First Answer</label>' + '<input type="text" class="form-control">' + '<div class="form-check">' + '<input class="form-check-input" type="radio">' + '<label class="form-check-label" > Is True </label>' + '</div>' + '</div>' + '<div class="form-group">' + '<label for"firstAnswer">Second Answer</label>' + '<input type="text" class="form-control">' + '<div class="form-check">' + '<input class="form-check-input" type="radio">' + '<label class="form-check-label" > Is true </label>' + '</div>' + '</div>';
  $("#answer-block").append(html);
}
